        ...
        <div className="h-full p-6 flex items-start text-slate-700 gap-4">
            ...
            <form onSubmit={onSubmitHandler} className="w-full p-4 max-w-lg bg-white rounded-lg border border-gray-200">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-xl font-medium">Resume Review</h1>
                </div>
                ...
                <p className="text-xs text-gray-600 font-light mt-1">Supports PDF resume only.</p>
            ...
            {/* Right Col */}
            <div className="w-full max-w-lg p-4 rounded-lg bg-white flex flex-col border border-gray-200 min-h-90 max-h-150">
                <div className="flex items-center gap-3">
                ...
                <div className="flex-1 flex justify-center items-center">
                    ...
                    <div className="mt-3 w-full h-full overflow-y-scroll text-sm text-slate-600">
