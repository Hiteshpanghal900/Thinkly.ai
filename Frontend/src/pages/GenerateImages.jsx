...
const GenerateImages = () => {
    ...
    const imageStyle = ['Realistic', 'Ghibli Style', 'Anime Style', 'Fantasy Style', '3D Style', 'Portrait Style', 'Cartoon Style']
    ...
    const onSubmitHandler = async(e) =>{
        ...
        try{
            setLoading(true)
                ...
                const {data} = await axios.post('/api/ai/generate-blog-title', {prompt, publish}, {
