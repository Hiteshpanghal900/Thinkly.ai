...
import { House, SquarePen, Hash, Image, FileText, Users, Icon, Eraser, Scissors, Key, LogOutIcon } from 'lucide-react';
...
const Sidebar = ({sidebar, setSidebar}) => {
  ...
  return (
    <div className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-14 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'} duration-300 transition-all`}>
