...
const CreationItem = ({item}) => {
    ...
    return (
        <div onClick={() => setExpanded(!expanded)} className="p-4 max-w-5xl text-sm cursor-pointer border border-gray-200 rounded-lg bg-white">
            ...
            </div>
            {
                expanded && (
                    <div>{item.type === 'image' ? (
                        <img src={item.content} alt="" className="mt-3 w-full max-w-wd"/>
                    ) : (
